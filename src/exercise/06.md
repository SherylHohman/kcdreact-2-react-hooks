...
boundary component handles the error. We will cover that in the next extra
credit. Here we are just rewriting the UI so we do not crash it to a white
screen of death.

TODO: create a PR for above line in 06.md (main branch, Dodds repo)
