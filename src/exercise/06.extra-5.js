...
// SH fetch states (I prefer CONST over magic strings, also helps for typos)
const IDLE = 'idle'
...
class ErrorBoundary extends React.Component {
  ...
  //  For this version of the app, I have renamed the various instances of the
  //	Error to be simply 'error' everywhere! Last extra credit I purposely used
  //	different var names, so it was clear where it was coming from. Here,
  //	just understand that I name it the same as the var received from React.
...
function PokemonInfo({pokemonName}) {
  ...
  React.useEffect(() => {
    ...
    // method 2: use then(success, failure) OR use method 1: .then, .catch
