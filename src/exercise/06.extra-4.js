...
class ErrorBoundary extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {errorBoundaryMessage: null} // this is local, not the error passed in
  }
  ...
  render() {
    ...
    if (error) {
      console.log(
        'ErrorBoundary, error render. THIS LINE NEVER GETS PRINTED!! 	BUT BELOW GETS RENDERED',
        error,
      )
