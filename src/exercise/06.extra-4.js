...
class ErrorBoundary extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {errorBoundaryMessage: false} // this is local, not the error passed in
  }
  ...
  static getDerivedStateFromError(error) {
	...
	*/
    ...
    // console.log(
    //   'componentDidCatch',
    //   Boolean(this.state.errorBoumdaryMessage),
    //   this.state.errorBoumdaryMessage,
    // )

    // Ah Haaaa! from video:
    //	[By addint this getDerivedStateFromError method, we not only turn this
    //		component into one that handles errors...
    //		]
    //	That'll [it/the component will] give us an error.
    //	(unclear! but I think that means the this method gives us access to
    //		an error object that is generated by React during one of its
    //		Lifecycle, rendering, or ??oneOtherSituation?RemWhat
    //	)
    ...
    return {errorBoumdaryMessage: error} // CORRECT, notice it is shorthand for:
    // return {error: error}
  }
  render() {
    ...
    if (error) {
      console.log('ErrorBoundary, error render', error)
